...
describe('test suite: renderOrderSummary', () => {
    ...
    it('displays the cart', () => {
        ...
        expect(cartItems[0].innerText).toContain('Quantity: 2');
        expect(cartItems[1].innerText).toContain('Quantity: 1');
        expect(cartItems[0].innerText).toContain('Black and Gray Athletic Cotton Socks - 6 Pairs');
        expect(cartItems[1].innerText).toContain('Intermediate Size Basketball');
        expect(cartItems[0].innerText).toContain('$10.90');
        expect(cartItems[1].innerText).toContain('$20.95');
